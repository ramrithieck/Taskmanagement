...
SECRET_KEY = 'django-insecure-&i)6gmi=f4qbpgdl2-t3sp@)&zvd(dxbihx&iplh$)=a)g1w^%'
...
DATABASES = {
    'default': {
        ...
        'USER': 'postgres',
        'PASSWORD':'123456',
        'HOST':'127.0.0.1',    #host for django admin host
        'PORT': '5432',
    }
}
...
CORS_ALLOWED_ORIGINS = [
    ...
    "http://127.0.0.1:8000",  # Replace with deployed frontend domain
]

# Allow all origins temporarily (for development only)
# If needed, comment out the line below in production
